 <?php if($title == "index" ){ echo "current-menu-item";}?>
                                    ...
                                    <nav class="navbar  nav-left">									
                                        ...
                                        <div class="collapse navbar-collapse">
                                            <ul class="nav navbar-nav pi-nav">
                                                <li class=" <?php if($title == 'home' ){ echo 'current-menu-item';}?> ">
                                                ...
                                                <li class=" <?php if($title == 'about' ){ echo 'current-menu-item';}?> ">
                                                <a href="about.php">About</a>
                                                    
                                                </li>
                                                <li class="dropdown  <?php if($title == 'services' ){ echo 'current-menu-item';}?> ">
                                                    <a href="#">Services</a> 
                                                    <ul class="dropdown-menu">
                                                ...
                                                <li class=" <?php if($title == 'Gallery' ){ echo 'current-menu-item';}?> ">
                                                    <a href="gallery.php">Gallery</a>                                          
                                                </li>
                                                <li class=" <?php if($title == 'featured' ){ echo 'current-menu-item';}?> ">
                                                    <a href="gallery.php">Featured Halls</a>                                          
                                                </li>
                                                <!-- <li>
                                                    <a href="blog.php">Blog</a>                                          
                                                </li> -->
                                                <li class=" <?php if($title == 'contact' ){ echo 'current-menu-item';}?> ">
