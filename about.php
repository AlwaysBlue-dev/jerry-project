        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <img src="img/about-custom/2.jpg" alt="Royal Plate - Restaurant & Catering HTML Template" />
                </div><!-- .col-md-6 end -->
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6 centered">
                    ...
                    <p>Throughout the year, fine signature has made a standing of greatness in the catering services. It has developed to turn into the best caterer and specialist for the catering business in the area. It became one of the fastest developing food and expert organizations by offering an expansive scope of excellent management. </p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6  centered">
                    ...
                    <p>A fresh breeze can refresh your day up in just a moment; we offer to arrange cruise parties around the sea. You can have bridal showers, bachelorette, or any event that you want and have a memorable day.</p>
                    <a href="#" class="more-details triggerAnimation animated" data-animate='fadeInUp'>Find a table <i class="fa fa-angle-double-right"></i></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 centered">
                    ...
                    <p>We invest our time to set up our Menus. We realize that every one of you is unique, so we guarantee that no two occasions of our own have a similar Menu. We sit with you and decide our Menus dependent on the demand. We invest our time to set up your Menus. We deliver the best from our British, Chinese, Italian, German, Australian, Irish, Arab, and American cuisine and can provide anything you desire. We realize that every one of you is unique, so we guarantee that no two occasions of our own have a similar Menu. We sit with you and decide our Menus dependent on the demand.
                    </p>
                    <a href="#" class="more-details triggerAnimation animated" data-animate='fadeInUp'>Find a table <i class="fa fa-angle-double-right"></i></a>
                </div><!-- .col-md-6 end -->
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6">
                    <img src="img/home-custom/1.jpg" alt="Royal Plate - Restaurant & Catering HTML Template" />
                </div><!-- .col-md-6 end -->
            </div><!-- .row end -->
        </div><!-- .container end -->
    </div><!-- .page-content end -->
