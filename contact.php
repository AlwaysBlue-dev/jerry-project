      ...
      ?>
        ...
        <div class="page-content">
            ...
            <div class="container">
                ...
                <div class="row mb-0">
                    <div class="col-md-12 mb-20 centered triggerAnimation animated" data-animate='fadeIn'>
                        <div class="custom-heading style-1">
                            <h3><span>Have a question for us</span></h3>
                ...
                <div class="row">
                    <div class="col-md-12 centered">
                        <p class="emphasized-text">Phone: <span> +9234533320 & +9234533321</span></p>
                        <!-- form start -->
                        <form class="wpcf7">
                            <fieldset>
        ...
        <!-- .page-content start -->
        <div class="page-content custom-img-background dark bkg-img13 custom-col-padding mb-100">
            <div class="container">
                <!-- .row start -->
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        ...
                        <ul>
                            <li>Fine Signature,</li>
                            <li>Office No.202 2nd floor Dulara Business Center Plot No.19 Maniya Society Khalid Bin Waleed Road,</li>
