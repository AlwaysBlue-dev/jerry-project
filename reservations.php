...
<body>
    ...
    <div class="page-content">
            ...
            <div class="row mb-0">
                ...
                <!-- <div class="divider style-2 center">
                                ...
                                <span class="divider-svg">
                                    <img class="svg-brown" src="img/svg/heading-icon.svg" alt="Fine Signature & Catering HTML Template">
                                </span>
        ...
        <div class="page-content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- .col-md-12 start -->
                    <div class="col-md-12 centered open-table-widget-style-3">
        ...
        <!-- .page-content start -->
        <div class="page-content custom-img-background dark bkg-img19 custom-col-padding mb-100">
            <div class="container">
                <!-- .row start -->
                <div class="row">
                    <!-- .col-md-12 start -->
                    <div class="col-md-12 centered">
                        <div class="custom-heading style-1 triggerAnimation animated" data-animate='fadeInUp'>
                            ...
                            <div class="divider style-2 center">
                                <span class="hr-double left"></span>
                                <span class="divider-svg">
                                    <img src="img/svg/heading-icon.svg" alt="Fine Signature & Catering HTML Template">
                                </span>
                                <span class="hr-double right"></span>
                            </div>
                        </div><!-- .custom-heading.style-1 end -->
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <img src="img/services-custom/2.jpg" alt="Fine Signature- " />
                    </div><!-- .col-md-6 end -->
                    <!-- .col-md-6 start -->
        ...
        <div class="page-content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- .col-md-6 start -->
                    <div class="col-md-6 col-sm-6">
                        <img src="img/services-custom/1.jpg" alt="Fine Signature- " />
                    </div><!-- .col-md-6 end -->
                </div><!-- .row end -->
            </div><!-- .container end -->
        </div><!-- .page-content end -->
        ...
        <div class="page-content">
            <div class="container">
                ...
                <div class="row">
                    <!-- .col-md-6 start -->
                    <div class="col-md-6 col-sm-6">
                        <img src="img/services-custom/3.jpg" alt="Fine Signature- " />
                    </div><!-- .col-md-6 end -->
                    <!-- .col-md-6 start -->
                    <div class="col-md-6 col-sm-6 centered">
                        <div class="custom-heading style-1">
                            <!-- <h3><span>Indoor</span></h3> -->
                            <h3>Cruise Or Social Parties</h3>
